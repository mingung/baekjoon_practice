...
static void SelectDifficulty() {
    ...
    switch(swi){
        case  8: distance = EASY;     speed = 1; 	break;
        case  4: distance = NORMAL;   speed = 1; 	break;
        case  2: distance = HARD;  	  speed = 1; 	break;
        case  1: distance = EXTREME;  speed = 1; 	break;
        case 15: distance = LEGEND;   speed = 2;	break;
        default: distance = 0;	 	  speed = 0; 	break;
    }
...
static void ProcessTch(int tch, int *Line_Y1, int *Line_Y2, int *Line_Y3, int *max_Y, int *random_X1, int *random_X2, int *random_X3) {
	...
	if (*max_Y > 2 * GOAL - 159) {
		...
		if (*max_Y >= (GOAL - distance) && *max_Y <= (GOAL + distance)) {
